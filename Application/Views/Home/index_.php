...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <footer class="pt-5 d-flex justify-content-between">
                    ...
                    <ul class="nav m-0">
                        <li class="nav-item"><a class="nav-link text-secondary" aria-current="page" href="#">Privacy Policy</a></li>
                        <li class="nav-item"><a class="nav-link text-secondary" href="#">Terms and conditions</a></li>
    ...
    <script src="https://getbootstrap.com/docs/5.2/dist/js/bootstrap.bundle.min.js" type="text/javascript"></script>
